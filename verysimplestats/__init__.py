...
from verysimplestats.statistics import residuals  # NOQA
from verysimplestats.statistics import rsquared  # NOQA
from verysimplestats.statistics import standard_deviation  # NOQA
from verysimplestats.statistics import variance  # NOQA
